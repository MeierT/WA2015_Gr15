...
\parindent0pt Dijkstra geht bei seinem Algorithmus folgendermaßen vor: Er unterteilt die Knoten des Graphen zunächst einmal in drei Gruppen: Die Knoten, deren Schätzwert bereits feststehen ("black nodes"\footnote{DIJKSTRA Edsger W., FEIJEN W.H.J.: A Method of Programming,Cornwall: Addison-Wesley Publishing Company,1988, S.107 Z.24}), deren Nachfolger ("grey nodes"
Vgl. \cite[S. 108, Z.2-3]{OttWid90}
%\footnote{vergl. Ebd., S.108, Z.2-3}
) sowie unerreichbare Knoten, deren Schätzwerte gänzlich unbekannt sind ("white nodes" 
...
Der folgende Abschnitt bezieht sich direkt auf Dijkstras eigene Implementierung \footnote{DIJKSTRA Edsger W., FEIJEN W.H.J.: A Method of Programming,Cornwall: Addison-Wesley Publishing Company,1988, S.110-11}, die von Ottman und Widmayer aufgegriffen wurde \footnote{OTTMANN, Thomas; WIDMAYER Peter: Algorithmen und Datenstrukturen, Reihe Informatik Bd. 70, Mannheim: BI-Wissenschaftsverlag, 1990, S.573-574, Algorithmus}.\\
